...
public class Organization {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? organization.id == null : this.id.equals(organization.id)) &&
        ...
        (this.serverLDAP == null ? organization.serverLDAP == null : this.serverLDAP.equals(organization.serverLDAP)) &&
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.serverLDAP == null ? 0: this.serverLDAP.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("  serverLDAP: ").append(serverLDAP).append("\n");
