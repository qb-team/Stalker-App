...
public class LoginPresenter implements LoginContract.Presenter, LoginContract.onLoginListener{
    ...
    //Metodo invocato dalla View per passare le credenziali al Interactor per fare il login all'utente
    @Override
    ...
    //Metodo invocato nel Interactor tramite il Contract e chiama il metodo onLoginSuccess nella View
    @Override
    public void onSuccess(String message) {
        mLoginView.onLoginSuccess(message);
    }

    //Metodo invocato nel Interactor tramite il Contract e chiama il metodo onLoginFailure nella View
    @Override
