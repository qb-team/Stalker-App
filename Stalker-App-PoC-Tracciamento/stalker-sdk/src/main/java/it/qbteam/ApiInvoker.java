...
import it.qbteam.auth.Authentication;
import it.qbteam.auth.ApiKeyAuth;
import it.qbteam.auth.HttpBasicAuth;
import it.qbteam.request.GetRequest;
import it.qbteam.request.PostRequest;
import it.qbteam.request.PutRequest;
import it.qbteam.request.DeleteRequest;
import it.qbteam.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("OpenAPI-Generator/0.0.1-SNAPSHOT/android");
